...
export default function DpePage() {
  ...
  useEffect(() => {
    if (!data || !data.dpe || !window.ApexCharts) return;
    ...
    const rawDpe = data.dpe;

    const barData = rawDpe.map((d) => ({
      name: d.name || d.classe || 'Inconnu',
    ...
    if (privateChartEl) {
      ...
      const chart1 = new window.ApexCharts(privateChartEl, getBarOptions(barData, 'Classes DPE'));
      chart1.render();
    ...
    if (privateDonutEl) {
      ...
      const chart2 = new window.ApexCharts(privateDonutEl, getDonutOptions(pieData, 'DPE'));
      chart2.render();
              ...
              <div id="privateChart" style={{ height: '380px' }}>
                {loading && (
                  <div className="rt-loading-wrapper">
                    ...
                    <div className="rt-loading-text">Analyse énergétique...</div>
                  </div>
                )}
              </div>
            </div>
              ...
              <div className="volume-card-content">
                <div className="chart-section">
                  ...
                  <div className="chart-center-label">
                    <span className="chart-center-text">DPE</span>
                  </div>
                </div>
